...
export function HeroSection() {
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-6 w-full relative z-10 pt-28 pb-20 text-center">
        ...
        <h1 className="text-balance leading-[0.85] mb-6" style={{ fontFamily: "var(--font-display)" }}>
          <div className="flex items-baseline justify-center gap-2 sm:gap-4">
            <span className="text-5xl sm:text-8xl md:text-[9rem] xl:text-[11rem] font-medium tracking-[-0.03em] text-primary">
              Pratic
            </span>
      ...
      >
        <span className="block text-[10px] uppercase tracking-[0.3em] mb-2 mt-2">
          Explore
        </span>
